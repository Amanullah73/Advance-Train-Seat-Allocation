...
<body>
    ...
    <table cellpadding="10" style="font-size: 30px; color: Blue; font-weight: bolder; background-color: #FFCC66;"
        width="100%" border="5" bgcolor="fuchsia" bordercolor="purple">
        <tr>
            <td>
                <span class="style3">BOOKING DETAILS OF THE PASSENGER</span>
            </td>
        </tr>
    </table>
